...
CREATE TABLE `图书` (
  ...
  `publicatation_date` date DEFAULT NULL,
...
INSERT INTO `book` VALUES (1,'边城','沈从文','机械工业出版社',36.00,NULL,'小城故事多'),(2,'骆驼祥子','老舍','中国教育出版社',43.00,'2016-10-01','你是祥子么'),(3,'茶馆','老舍','中国文学出版社',55.00,'2016-10-01','老北京'),(4,'呐喊','鲁迅','中国教育出版社',51.00,NULL,'最后的声音'),(5,'围城','钱钟书','中国文学出版社',54.00,'2018-01-01','你心中的围城是什么'),(7,'朝花夕拾','鲁迅','中国文学出版社',47.00,'2018-01-01',NULL);
...
-- Dump completed on 2020-04-01 16:03:54
